        ...
        <table class="table table-bordered" id="tablaCertificaciones">
          ...
          while($row_certificacion = mysql_fetch_assoc($certificacion_detalle)){
            ...
            <tr class="text-center">
              ...
              <td><input type="date" class="form-control claseModificar" name="ano_inicial[$contador]" id="exampleInputEmail1" placeholder="AÑO INICIAL" value="<?echo $row_certificacion['ano_inicial']?>" readonly></td>
