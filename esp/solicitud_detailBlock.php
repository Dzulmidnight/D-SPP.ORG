...
/************************* SE DENIEGA Y ENVIAR A REVISION***********************************/
...
<div class="panel panel-primary">
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <?php if(empty($row_solicitud['cotizacion_opp'])){ ?>
          ...
          <div class="col-xs-6">
            <input name="cotizacion_opp" type="file" class="filestyle" data-buttonName="btn-info" data-buttonBefore="true" data-buttonText="Cargar Cotización"> 
          </div>
  ...
  <div class="panel-footer">
       ...
       ?>
          <div class="row">
            <div class="col-xs-2">
              <button class="btn btn-success" id="cotizacion" name="cotizacion" type="submit" value="Enviar" aria-label="Left Align">
            ...
            <div class="col-xs-3">
              <button class="btn btn-danger" id="denegado" name="denegado" type="submit" value="denegado" aria-label="Left Align">
	...
	<table class="table table-bordered table-striped col-xs-8">
			...
			<td colspan="1">
				...
				<?php 
					if(isset($row_opp['telefono1'])){
						echo "<input type='text' class='form-control' name='telefono' id='exampleInputEmail1' value='$row_opp[telefono1]' disabled>";
					}else{
		...
		<tr>
			<?php 
			 ...
			 ?>		
			<td class="col-xs-3">RUC: <input type="text" class="form-control" name="ruc" id="exampleInputEmail1" placeholder="RUC" value="<?php echo $row_solicitud['ruc']?>" disabled></td>
			
			<td class="col-xs-3">CIUDAD: <input type="text" class="form-control" name="ciudad" id="exampleInputEmail1" placeholder="Ciudad" value="<?php echo $row_solicitud['ciudad']?>" disabled></td>
		</tr>
		...
		<tr>
			<td colspan="2">
				...
				<input type="text" class="form-control" name="p1_nombre" id="exampleInputEmail1" placeholder="Contacto Solicitud 1" value="<?php echo $row_solicitud['p1_nombre']?>" disabled><br>
				<input type="text" class="form-control" name="p2_nombre" id="exampleInputEmail1" placeholder="Contacto Solicitud 2" value="<?php echo $row_solicitud['p2_nombre']?>" disabled><br>
				CORREO ELECTRÓNICO DE CONTACTO
				<input type="email" class="form-control" name="p1_email" id="exampleInputEmail1" placeholder="Correo Electrónico 1" value="<?php echo $row_solicitud['p1_email']?>" disabled><br>
				<input type="email" class="form-control" name="p2_email" id="exampleInputEmail1" placeholder="Correo Electrónico 2" value="<?php echo $row_solicitud['p2_email']?>" disabled><br>
			</td>
			<td colspan="2">
				CARGO<br>
				<input type="text" class="form-control" name="p1_cargo" id="exampleInputEmail1" placeholder="Cargo 1" value="<?php echo $row_solicitud['p1_cargo']?>" disabled><br>
				<input type="text" class="form-control" name="p2_cargo" id="exampleInputEmail1" placeholder="Cargo 2" value="<?php echo $row_solicitud['p2_cargo']?>" disabled><br>
				TELÉFONO<br>
				<input type="text" class="form-control" name="p1_telefono" id="exampleInputtext1" placeholder="Telefono 1" value="<?php echo $row_solicitud['p1_telefono']?>" disabled><br>
				<input type="text" class="form-control" name="p2_telefono" id="exampleInputEmail1" placeholder="Telefono 2" value="<?php echo $row_solicitud['p2_telefono']?>" disabled><br>
			</td>
		</tr>
		<tr class="text-center warning">
		...
		<tr>
			<td colspan="2">
				...
				<input type="text" class="form-control" name="adm_nom1" id="exampleInputEmail1" placeholder="Persona del Área Administrativa 1" value="<?php echo $row_solicitud['adm_nom1']?>" disabled><br>
				<input type="text" class="form-control" name="adm_nom2" id="exampleInputEmail1" placeholder="Persona del Área Administrativa 2" value="<?php echo $row_solicitud['adm_nom2']?>" disabled><br>
				CORREO ELECTRÓNICO DEL ÁREA ADMINISTRATIVA
				<input type="email" class="form-control" name="adm_email1" id="exampleInputEmail1" placeholder="Correo Electrónico 1" value="<?php echo $row_solicitud['adm_email1']?>" disabled><br>
				<input type="email" class="form-control" name="adm_email2" id="exampleInputEmail1" placeholder="Correo Electrónico 2" value="<?php echo $row_solicitud['adm_email2']?>" disabled>
			</td>
			<td colspan="2">
				TELÉFONO PERSONA DEL ÁREA ADMINISTRATIVA<br>
				<input type="text" class="form-control" name="adm_tel1" id="exampleInputEmail1" placeholder="Teléfono Área Adminsitrativa 1" value="<?php echo $row_solicitud['adm_tel1']?>" disabled><br>
				<input type="text" class="form-control" name="adm_tel2" id="exampleInputEmail1" placeholder="Teléfono Área Administrativa 2" value="<?php echo $row_solicitud['adm_tel2']?>" disabled>
			</td>
		</tr>	
		<tr >
			<td>NÚMERO DE SOCIOS PRODUCTORES</td>
			<td><input type="text" class="form-control" name="resp1" id="exampleInputEmail1" placeholder="Número de socios" value="<?php echo $row_solicitud['resp1']?>" disabled></td>
			<td>NÚMERO DE SOCIOS PRODUCTORES DEL (DE LOS) PRODUCTO(S) A INCLUIR EN LA CERTIFICACION</td>
			<td><input type="text" class="form-control" name="resp2" id="exampleInputEmail1" placeholder="Número de socios" value="<?php echo $row_solicitud['resp2']?>" disabled></td>
		</tr>

		<tr >
			<td>NÚMERO DE SOCIOS PRODUCTORES</td>
			<td><input type="text" class="form-control" name="resp3" id="exampleInputEmail1" placeholder="Número de socios" value="<?php echo $row_solicitud['resp3']?>" disabled></td>
			<td>NÚMERO DE SOCIOS PRODUCTORES DEL (DE LOS) PRODUCTO(S) A INCLUIR EN LA CERTIFICACION</td>
			<td><input type="text" class="form-control" name="resp4" id="exampleInputEmail1" placeholder="Número de socios" value="<?php echo $row_solicitud['resp4']?>" disabled></td>
		</tr>
		<tr class="success">
		...
		<tr>
			<td colspan="4">
				...
				<br>
				<textarea class="form-control" name="op_resp1" id="" rows="3" disabled><?php echo $row_solicitud['op_resp1']?></textarea>
		...
		<tr>
			<td>
				...
				<textarea class="col-xs-12 form-control" name="op_area1" id="" cols="10" rows="5" disabled><?php echo $row_solicitud['op_area1']?></textarea>
				
			</td>
			<td>
				<h5 class="col-xs-12">NÚMERO DE OPP DE 2DO GRADO:</h5>	
				<textarea class="col-xs-12 form-control" name="op_area2" id="" cols="10" rows="5" disabled><?php echo $row_solicitud['op_area2']?></textarea>	
			</td>
			<td>
				<h5 class="col-xs-12">NÚMERO DE OPP DE 1ER GRADO:</h5>
				<textarea class="col-xs-12 form-control" name="op_area3" id="" cols="10" rows="5" disabled><?php echo $row_solicitud['op_area3']?></textarea>
			</td>
			<td>
				<h5 class="col-xs-12">NÚMERO DE COMUNIDADES, ZONAS O GRUPOS DE TRABAJO:</h5>
				<textarea class="col-xs-12 form-control" name="op_area4" id="" cols="10" rows="5" disabled><?php echo $row_solicitud['op_area4']?></textarea>
		...
		<tr>
			<td colspan="4">
				<textarea name="op_resp2" id="" class="form-control" rows="3" disabled><?php echo $row_solicitud['op_resp2']?></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td colspan="4">
				<textarea name="op_resp3" id="" class="form-control" rows="3" disabled><?php echo $row_solicitud['op_resp3']?></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="4">
...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
            ...
            if($posicion_coincidencia === false){
              echo "PRODUCCIÓN <input name='op_resp4[]' type='checkbox' value='PRODUCCION' disabled>";
            }else{
              echo "PRODUCCIÓN <input name='op_resp4[]' type='checkbox' value='PRODUCCIÓN' checked disabled>";
            } 
          ?>
...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
            ...
            if($posicion_coincidencia === false){
              echo "PROCESAMIENTO <input name='op_resp4[]' type='checkbox' value='PROCESAMIENTO' disabled>";
            }else{
              echo "PROCESAMIENTO <input name='op_resp4[]' type='checkbox' value='PROCESAMIENTO' checked disabled>";
            } 
          ?>
        </div>
        <div class="col-xs-4">
...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
            ...
            if($posicion_coincidencia === false){
              echo "EXPORTACIÓN <input name='op_resp4[]' type='checkbox' value='EXPORTACION' disabled>";
            }else{
              echo "EXPORTACIÓN <input name='op_resp4[]' type='checkbox' value='EXPORTACION' checked disabled>";
            } 
          ?>          
        </div>
			</td>
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp5" id="" rows="3" disabled><?php echo $row_solicitud['op_resp5']?></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp6" id="" rows="3" disabled><?php echo $row_solicitud['op_resp6']?></textarea>
			</td>
		</tr>		
		<tr>
			<td colspan="4">
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp7" id="" rows="3" disabled><?php echo $row_solicitud['op_resp7']?></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp8" id="" rows="3" disabled><?php echo $row_solicitud['op_resp8']?></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
		...
		<tr>
          ...
          while($row_certificacion = mysql_fetch_assoc($certificacion_detalle)){
            ...
            <tr class="text-center">
              <td><input type="text" class="form-control" name="certificacion[$contador]" id="exampleInputEmail1" placeholder="CERTIFICACIÓN" value="<?echo $row_certificacion['certificacion']?>" disabled></td>
              <td><input type="text" class="form-control" name="certificadora[$contador]" id="exampleInputEmail1" placeholder="CERTIFICADORA" value="<?echo $row_certificacion['certificadora']?>" disabled></td>
              <td><input type="date" class="form-control" name="ano_inicial[$contador]" id="exampleInputEmail1" placeholder="AÑO INICIAL" value="<?echo $row_certificacion['ano_inicial']?>" disabled></td>
              <td><input type="text" class="form-control" name="interrumpida[$contador]" id="exampleInputEmail1" placeholder="¿HA SIDO INTERRUMPIDA?" value="<?echo $row_certificacion['interrumpida']?>" disabled></td>
            </tr>
          <?php $contador++; } ?> 
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp10" id="" rows="3" disabled><?php echo $row_solicitud['op_resp10']?></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp11" id="" rows="3" disabled><?php echo $row_solicitud['op_resp11']?></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
        ...
        <?php
          if($row_solicitud['op_resp12'] == 'SI'){
              //echo "SI <input type='radio' name='op_resp12'  checked disabled>";
            /*echo "</div>";
            echo "<div class='col-xs-6'>";
              echo "<p class='text-center alert alert-danger'>NO</p>";
              echo "NO <input type='radio' name='op_resp12'  disabled>";
            echo "</div>";*/
        ?>
          <div class="col-xs-6">
		...
		<tr>
			<td colspan="4">
				<textarea class="form-control" name="op_resp14" id="" rows="3" disabled><?php echo $row_solicitud['op_resp14']?></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
      ...
      <?php }else{ ?>
        <td colspan="4">
          ...
          <a class="btn btn-success" href="http://d-spp.org/opp/<?echo $row_solicitud['op_resp15']?>" target="_blank"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Descargar Croquis</a>
		...
		<tr>
          ...
          while($row_producto = mysql_fetch_assoc($producto_detalle)){
            ?>
					...
					<tr>
						<td>
							<input type="text" class="form-control" name="producto[$contador]" id="exampleInputEmail1" placeholder="Producto" value="<?echo $row_producto['producto']?>" disabled>
						</td>
						<td>
							<input type="text" class="form-control" name="volumen[$contador]" id="exampleInputEmail1" placeholder="Volumen" value="<?echo $row_producto['volumen']?>" disabled>
						</td>
						<td>
              <?php 
                if($row_producto['terminado'] == 'SI'){
                  echo "SI <input type='radio'  name='terminado".$contador."[$contador]' id=' value='SI' checked disabled><br>";
                }else if($row_producto['terminado'] == 'NO'){
                  echo "NO <input type='radio'  name='terminado".$contador."[$contador]' id=' value='NO' checked disabled>";
                }
               ?>
            </td>          
						<td>
							<textarea cols="30" rows="5" type="text" class="form-control" name="materia[$contador]" id="exampleInputEmail1" placeholder="Materia" disabled><?echo $row_producto['materia']?></textarea>
						</td>
						<td>
							<textarea cols="30" rows="5" type="text" class="form-control" name="destino[$contador]" id="exampleInputEmail1" placeholder="Destino" disabled><?echo $row_producto['destino']?></textarea>
						</td>
						<td>
              <?php 
                if($row_producto['marca_propia'] == 'SI'){
                  echo "SI <input type='radio'  name='marca_propia".$contador."[0]' id=' value='SI' checked disabled><br>";
                }else if($row_producto['marca_propia'] == 'NO'){
                  echo "NO <input type='radio'  name='marca_propia".$contador."[0]' id=' value='NO' checked disabled>";
                }
               ?>
						</td>
						<td>
              <?php 
                if($row_producto['marca_cliente'] == 'SI'){
                  echo "SI <input type='radio'  name='marca_cliente".$contador."[0]' id=' value='SI' checked disabled><br>";
                }else if($row_producto['marca_cliente'] == 'NO'){
                  echo "NO <input type='radio'  name='marca_cliente".$contador."[0]' id=' value='NO' checked disabled>";
                }
               ?>              
						</td>
						<td>
              <?php 
                if($row_producto['sin_cliente'] == 'SI'){
                  echo "SI <input type='radio'  name='sin_cliente".$contador."[0]' id=' value='SI' checked disabled><br>";
                }else if($row_producto['sin_cliente'] == 'NO'){
                  echo "NO <input type='radio'  name='sin_cliente".$contador."[0]' id=' value='NO' checked disabled>";
                }
               ?> 
						</td>
					</tr>
