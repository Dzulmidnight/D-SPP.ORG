...
if(isset($_POST['nuevo_trim']) && $_POST['nuevo_trim'] == 'SI'){
	...
	$ano = date('Y', time());
	$idtrim = 'T_OPP'.$_GET['trim'].'-'.$ano.'-'.$idopp;
	$estado_trim = "ACTIVO";
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $informe['comprador']; ?></td>
							...
							<td><?php echo $informe['total_contrato']; ?></td>
						</tr>
					<?php
					$monto_total = $informe['total_contrato'] + $monto_total; 
					$contador++;
					}
