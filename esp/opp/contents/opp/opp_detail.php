...
<? if(isset($_GET['contact'])){?> class="active" <? }?>><a href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&contact">Contactos</a></li>
  
  <li role="presentation"
<? if(isset($_GET['cta'])){?> class="active" <? }?>><a href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&cta">Cuentas bancarias</a></li>

 <li role="presentation"
<? if(isset($_GET['action'])){?> class="active" <? }?>><a href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&action">Ultimas acciones</a></li>
  ...
  <h4><a class="btn btn-success" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&contact=add">Agregar</a> <a class="btn btn-default" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&contact">Contactos</a></h4>
...
<table>
  ...
  <h4><a class="btn btn-success" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&cta=add">Agregar</a> <a class="btn btn-default" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&cta">Cuentas bancarias</a></h4>
  ...
  <input type="text" name="mensaje" value="Cuenta agregada correctamente" />
  <input type="text" name="idopp" value="<? echo $_SESSION['idopp'];?>" />
  <input  type="text" name="MM_insert" value="form4" />
</form>
...
<? }else{?>
  ...
  <h4><a class="btn btn-success" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&action=add">Agregar</a> <a class="btn btn-default" href="?OPP&detail&idopp=<? echo $_SESSION['idopp'];?>&action">Ultimas acciones</a></h4>
