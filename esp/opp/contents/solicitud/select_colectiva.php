      ...
      <tbody>
        ...
        if($total_solicitudes != 0){
            ...
            <tr>
              <td>
                <form action="../../reportes/solicitud.php" method="POST" target="_new">
                  <button class="btn btn-xs btn-default" data-toggle="tooltip" title="Descargar solicitud" target="_new" type="submit" ><?php echo $solicitud['idsolicitud_colectiva']; ?> <img src="../../img/pdf.png" style="height:30px;" alt=""></button>
          ...
          <!--<form action="" method="POST" enctype="multipart/form-data">-->
              ...
              <td>
                <input type="hidden" name="tipo_solicitud" value="<?php echo $solicitud['tipo_solicitud']; ?>">
                <a class="btn btn-sm btn-primary" style="display:inline-block" href="?SOLICITUD&amp;detail&amp;idsolicitud_colectiva=<?php echo $solicitud['idsolicitud_colectiva']; ?>" data-toggle="tooltip" title="Visualizar Solicitud" >
                  Consultar
                </a>
