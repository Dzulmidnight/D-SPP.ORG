	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
					...
					if($registros['estatus_membresia'] == 'EN ESPERA' && isset($registros['archivo'])){
						echo '<form action="" method="POST" style="display:inline-block">';
							echo '<button name="aprobar_comprobante" value="'.$registros['idmembresia'].'" class="btn btn-xs btn-success" data-toggle="tooltip" title="Autorizar membresia" onclick="return confirm(\'¿Desea Aprobar el Comprobante de pago?\');">
								<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
							</button>';

							echo '<button name="rechar_comprobante" value="'.$registros['idmembresia'].'" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Rechazar membresia" onclick="return confirm(\'¿Desea Rechazar el Comprobante de Pago?\');">
					...
					?>
						<a class="btn btn-xs btn-primary" href="<?php echo $registros['archivo']; ?>" target="_blank" data-toggle="tooltip" title="Descargar Comprobante">
				...
				<td><?php echo $registros['abreviacion_opp']; ?></td>
				...
				<td><?php echo date('d/m/Y', $registros['fecha_dictamen']); ?></td>
				<td><?php echo $registros['pais'] ?></td>
				<td><?php echo $registros['monto']; ?></td>
				<td class="<?php echo $estatus; ?>"><?php echo $registros['estatus_membresia']; ?></td>
				<td>
					<?php 
