  ...
  <form action="" name="" method="POST" enctype="multipart/form-data">
    <fieldset>
      ...
      <div class="col-md-12 alert alert-info">
        <p>
          <strong>VALOR TOTAL DE VENTAS (independientemente de si se trata de ventas SPP o no) </strong>
            <br>
      ...
      <div class="row">
        ...
        <div id="contenedor_tablaEmpresas" class="col-md-12" style="display:none">
          ...
          <p><b>15. ¿TUVO COMPRAS SPP DURANTE EL CICLO DE REGISTRO ANTERIOR?</b></p>
          <div class="col-xs-12 ">
                <?php
                  if($solicitud['preg13'] == 'SI'){
                      //echo "SI <input type='radio' name='preg12'  checked readonly>";
                    /*echo "</div>";
                    echo "<div class='col-xs-6'>";
                      echo "<p class='text-center alert alert-danger'>NO</p>";
                      echo "NO <input type='radio' name='preg12'  readonly>";
                    echo "</div>";*/
                ?>
                  <div class="col-xs-6">
