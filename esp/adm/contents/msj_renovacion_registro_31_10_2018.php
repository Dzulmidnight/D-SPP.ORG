        ...
        <tr>
          ...
          <td>
            ...
            if(!isset($existe_solicitud['idsolicitud_registro'])){
                ...
                $query_oc = "SELECT solicitud_registro.idoc, oc.email1, oc.email2 FROM solicitud_registro INNER JOIN oc ON solicitud_registro.idoc = oc.idoc WHERE solicitud_registro.idsolicitud_registro = '$existe_solicitud[idsolicitud_registro]'";
                $row_oc = mysql_query($query_oc, $dspp) or die(mysql_error());
                $detalle_oc = mysql_fetch_assoc($row_oc);
