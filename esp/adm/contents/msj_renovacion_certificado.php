        ...
        <tr>
          ...
          <td <?php echo $clase1; ?>>
            ...
            /*****/
              ...
              $query_solicitud = "SELECT solicitud_certificacion.idsolicitud_certificacion FROM solicitud_certificacion WHERE solicitud_certificacion.idopp = '$certificado[idopp]' AND FROM_UNIXTIME(solicitud_certificacion.fecha_registro, '%Y') = '$anio_solicitud'";
              $consul_solicitud = mysql_query($query_solicitud, $dspp) or die(mysql_error());
              $existe_solicitud = mysql_fetch_assoc($consul_solicitud);
            /*****/

            if(!isset($existe_solicitud['idsolicitud_certificacion'])){
              if(!isset($aviso_renovacion['idaviso_renovacion']) || !isset($aviso_renovacion['aviso1'])){
                if($time_actual >= $primer_aviso){
                  
                  /* INICIA ENVIAR NOTIFICACIÓN RENOVACIÓN CERTIFICADO */
                  if($certificado['entidad'] != 15 && $certificado['entidad'] != 19){
                  ...
                  /* TERMINA ENVIAR NOTIFICACIÓN RENOVACIÓN CERTIFICADO */
            ...
            if(!isset($existe_solicitud['idsolicitud_certificacion'])){
              if(!isset($aviso_renovacion['aviso2'])){
                if($time_actual >= $segundo_aviso){
                  ...
                  /* INICIA AVISO RENOVACIÓN DEL CERTIFICADO */
                  if($certificado['entidad'] != 15 && $certificado['entidad'] != 19){
                  ...
                  /* TERMINA AVISO DE RENOVACIÓN DEL CERTIFICADO */
          ...
          <td <?php echo $clase3; ?>>
            ...
            /*****/
              if(!isset($aviso_renovacion['aviso3'])){
                ...
                /* revisamos si existen solicitudes */
                if(!isset($existe_solicitud['idsolicitud_certificacion'])){

                  if($time_actual >= $tercer_aviso){
                    /* INICIA AVISO DE RENOVACIÓN DEL CERTIFIACDO */
                    if($certificado['entidad'] != 15 && $certificado['entidad'] != 19){
                  ...
                  //echo '<h4 style="color:green">SI HAY SOLICITUD</h4>';
                }
                /**/ 
              }/*else{
            ...
            if(!isset($existe_solicitud['idsolicitud_certificacion'])){
              if(!isset($aviso_renovacion['aviso4'])){
                if($time_actual >= $cuarto_aviso){
                  /* INICIO AVISO DE RENOVACIÓN DEL CERTIFICADO */
                  if($certificado['entidad'] != 15 && $certificado['entidad'] != 19){
                  ...
                  /* FIN AVISO DE RENOVACIÓN DEL CERTIFICADO */
