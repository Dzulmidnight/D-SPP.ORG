        ...
        ?>
          <tr <?php if($opp['estatus_interno'] == 10){ echo 'class="alert alert-danger"'; } ?>>
            ...
            <td>
              <?php 
                ...
                switch ($certificado['estatus_certificado']) {
                  case '13': //certificado "activo"
                    $clase = 'alert alert-success text-center';
                    break;
                  case '14': //certificado "renovacion"
                    $clase = 'alert alert-info text-center';
                    break;
                  case '15': //certificado "por expirar"
                    $clase = 'alert alert-warning text-center';
                    break;
                  case '16': //certificado "Expirado"
                    $clase = 'alert alert-danger text-center';
                    break;
              ...
              <?php echo "<p style='padding:5px;' class='".$clase."'>".$certificado['nombre']."</p>"; ?>
            </td>
            <!--- TERMINA FECHA_FINAL ---->
