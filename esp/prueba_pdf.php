...
<div class="col-xs-12">
	<?php
	if(isset($_POST['codigoHTML'])){
		$codigoHTML = $_POST['codigoHTML'];
	?>
		<?php
		echo $codigoHTML;
		?>
		<textarea class="form-control" name="" id="" cols="30" rows="10"><?php echo $codigoHTML; ?></textarea>
	<?php
	}else{
		echo "NO ES ENCONTRO VARIABLE";
	}
	?>
</div>
