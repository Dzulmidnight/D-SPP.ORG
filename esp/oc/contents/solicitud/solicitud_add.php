...
/*************************************************************************************************************************/
  ...
  echo "<script>window.location='?SOLICITUD&select&mensaje=Solicitud agregada correctamente, se ha notificado al OC por email.'</script>"; 
	    ...
	    <tr valign="baseline">
	  	    ...
	  	    <td class="text-center" colspan="3">
	  	    	...
	  	    	<tr style="border-lef-stylet:hidden">
	  	    		<td><h4>Tipo de Solicitud <small>(Seleccionar el tipo de solicitud que desea realizar)</small></h4></td>
	  	    		<td colspan="2">
