...
if(isset($_POST['insertar_solicitud']) && $_POST['insertar_solicitud'] == 1){
	...
	if(!empty($_POST['contacto2_nombre'])){
		...
		$row_empresa = mysql_query("SELECT * FROM empresa WHERE idempresa = $idempresa", $dspp) or die(mysql_error());
			...
			<body>
				...
				<table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
				  <tbody>
				    ...
				    <tr>
				      <td align="left">Teléfono / Company phone: '.$empresa['telefono'].'</td>
				    </tr>

				    <tr>
				      <td align="left">'.$empresa['pais'].'</td>
				    </tr>
				    <tr>
				      <td align="left" style="color:#ff738a;">Email: '.$empresa['email'].'</td>
				    </tr>
				    <tr>
...
$row_empresa = mysql_query("SELECT * FROM empresa WHERE idoc = $idoc", $dspp) or die(mysql_error());
		...
		<fieldset>
				...
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<select class="form-control" name="idempresa" id="" required>
							...
							?>
								<option value="<?php echo $empresa['idempresa']; ?>"><?php if(!empty($empresa['abreviacion'])){ echo $empresa['abreviacion']; }else{ echo $empresa['nombre']; } ?></option>
							<?php
							}
							 ?>
						</select>
			...
			<div class="col-lg-12">
				<div class="col-md-12">
					...
					<textarea name="preg3" id="preg3" class="form-control" rows="2"></textarea>
