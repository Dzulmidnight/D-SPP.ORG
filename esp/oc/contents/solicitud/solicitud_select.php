...
<div class="row">
  <div class="col-md-12">
    <table class="table table-condensed table-bordered" style="font-size:12px;">
      ...
      <tbody>
      <?php 
      while($solicitud_certificacion = mysql_fetch_assoc($consultar_solicitud)){
      ?>
        <tr>
          <td>
            <?php echo $solicitud_certificacion['idsolicitud_certificacion']; ?>
          </td>
          <td>
            <?php echo date('d/m/Y', $solicitud_certificacion['fecha_registro']); ?>
          </td>
          <td>
            <?php echo $solicitud_certificacion['abreviacion_opp']; ?>
          </td>
          <td>
            <?php
            if(isset($solicitud_certificacion['cotizacion_opp'])){
               echo $solicitud_certificacion['cotizacion_opp'];
          ...
          <td>
            <?php 
            if(isset($solicitud_certificacion['estatus_publico'])){
              echo $solicitud_certificacion['nombre_publico'];
            }else{
              echo "No Disponible";
            }
             ?>
          ...
          <td>
            <?php 
            if(isset($solicitud_certificacion['estatus_interno'])){
              echo $solicitud_certificacion['nombre_interno'];
            }else{
              echo "No Disponible";
            }
             ?>
          ...
          <?php 
          $query_certificado = "SELECT * FROM certificado WHERE idopp = $solicitud_certificacion[idopp]";
          ...
          <td>
            <?php 
            if(isset($solicitud_certificacion['observaciones'])){
              echo $solicitud_certificacion['observaciones'];
            }else{
              echo "No Disponible";
            }
             ?>
          ...
          <td>
            <a class="btn btn-primary" data-toggle="tooltip" title="Visualizar Solicitud" href="?SOLICITUD&IDsolicitud=<?php echo $solicitud_certificacion['idsolicitud_certificacion']; ?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
          </td>
          <td>
            <form action="../../reportes/reporte.php" method="POST" target="_new">
              ...
              <input type="hidden" name="idsolicitud_certificacion" value="<?php echo $solicitud_certificacion['idsolicitud_certificacion']; ?>">
