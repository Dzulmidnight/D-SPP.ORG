...
<div class="panel panel-default">
      ...
      <?php $cont=0; while ($row_opp = mysql_fetch_assoc($opp)) {$cont++; ?>
        <tr <?php if($row_opp['estado'] == 20){ echo "style='border-style:solid;border-color:#E74C3C'";}if($row_opp['status'] == 24){ echo "class='warning'";} ?>>
          <?php  $fecha = $row_opp['fecha_elaboracion']; ?>
            <td>
              <form action="../../reportes/reporte.php" method="POST" target="_new" style="display:inline">
                <div class="col-sm-12">
                  <button class="btn btn-xs btn-default" data-toggle="tooltip" title="Descargar solicitud" target="_new" type="submit" ><?php echo $row_opp['idsolicitud_certificacion'];  ?><img src="../../img/pdf.png" alt=""></button>
                </div>
 ...
 <!----------------------------------------- INICIA BOTON VER SOLICITUD ---------------------------------------------->
            <td>
              ...
              <!--<a href="../../reportes/reporte.php" target="_new"><img src="../../img/pdf.png" alt=""></a>-->
            </td>
