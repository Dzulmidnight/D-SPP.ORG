...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE oc SET idf=%s, password=%s, nombre=%s, abreviacion=%s, email=%s, pais=%s, fecha_creacion=%s, numero_socios=%s, razon_social=%s, direccion_fiscal=%s, rfc=%s WHERE idoc=%s",
...
$colname_contacto = "-1";
  ...
  $colname_contacto = $_SESSION['idoc'];
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table class="table">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text"  class="form-control" name="email" placeholder="Email Notificaciones y contacto" value="<?php echo htmlentities($row_OC['email'], ENT_COMPAT, ''); ?>" size="32" required/></td>
    </tr>
...
<? if(isset($_GET['contact'])){?> class="active" <? }?>><a href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&contact">Contactos</a></li>
  <li role="presentation"
<? if(isset($_GET['cta'])){?> class="active" <? }?>><a href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&cta">Cuentas bancarias</a></li>
  ...
  <h4><a class="btn btn-success" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&contact=add">Agregar</a> <a class="btn btn-default" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&contact">Contactos</a></h4>
  ...
  <form class="col-xs-8" action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
    ...
    <input type="hidden" name="idoc" value="<? echo $_SESSION['idoc'];?>" />
  ...
  <table class="table table-striped">
    ...
    <tr>
      <td><a class="btn btn-<? if($_GET['idcontacto']==$row_contacto['idcontacto']){echo "danger";}else{echo "default";}?>" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&contact=update&idcontacto=<?php echo $row_contacto['idcontacto']; ?>" style="width:100%"><?php echo $row_contacto['contacto']; ?></a></td>
      </tr>
    <?php } ?>
  </table>
  </div>
  ...
  <table class="table table-striped">
    ...
    <tr>
      <td><a class="btn btn-default" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&contact=update&idcontacto=<?php echo $row_contacto['idcontacto']; ?>" style="width:100%"><?php echo $row_contacto['contacto']; ?></a></td>
  ...
  <? }?>
  <? if(isset($_GET['cta'])){?>
  <h4><a class="btn btn-success" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&cta=add">Agregar</a> <a class="btn btn-default" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&cta">Cuentas bancarias</a></h4>
...
<table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        <td><a class="btn btn-<? if($_GET['idcta_bn']==$row_cta_bn['idcta_bn']){echo "danger";}else{echo "default";}?>" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&cta=update&idcta_bn=<?php echo $row_cta_bn['idcta_bn']; ?>" style="width:100%"><?php echo $row_cta_bn['banco']; ?></a></td>
        </tr>
      <?php }  ?>
      <? if($cont==0){?>
...
<? }else{?>
  <table class="table table-striped">
    ...
    <tbody>
      <?php $cont=0; while ($row_cta_bn = mysql_fetch_assoc($cta_bn)){ $cont++;?>
      <tr>
        <td><a class="btn btn-default" href="?OC&detail&idoc=<? echo $_SESSION['idoc'];?>&cta=update&idcta_bn=<?php echo $row_cta_bn['idcta_bn']; ?>" style="width:100%"><?php echo $row_cta_bn['banco']; ?></a></td>
