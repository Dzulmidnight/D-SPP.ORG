...
<h4>Menú principal Administrador</h4>
        ...
        /*
            ...
            $queryConsulta = "SELECT opp.*, certificado.*, certificado.status AS 'statusCertificado', status.nombre AS 'nombreStatus', oc.abreviacion AS 'abreviacionOC' FROM opp INNER JOIN certificado ON opp.idopp = certificado.idopp INNER JOIN oc ON certificado.entidad = oc.idoc INNER JOIN status ON opp.estado = status.idstatus ORDER BY vigenciafin";
            ...
            <div class="col-xs-12" id="tablaOPP" style="display:none;">
                <table class="table table-bordered table-hover">
                    <tr><td colspan="7" class="text-center"><h3>LISTA DE OPP CON FECHA DE CERTIFICADO</h3></td></tr>
                    <tr>
                        <td>Nº</td>
                        <!--<td>ID OPP</td>-->
                    ...
                    <tr>
                        ...
                        //19_04_2016 $destinatarioOPP.= $OCemail;
                        ...
                        $mail->Send();
                                ...
                                //19_04_2016 mail($destinatarioOPP,$asunto,utf8_decode($cuerpo),$headers);
        ...
        /*
            ...
            <div class="col-xs-12" id="tablaEmpresas" style="display:none;">
                <table class="table table-bordered table-hover">
                    <tr><td colspan="7" class="text-center"><h3>LISTA DE EMPRESAS CON FECHA DE CERTIFICADO</h3></td></tr>
                    <tr>
                        <td>Nº</td>
                        <!--<td>ID com</td>-->
                        <!--<td>ID CERTIFICADO</td>-->
