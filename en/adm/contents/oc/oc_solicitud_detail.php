...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
		...
		<tr>
          ...
          <?php 
          $query_certificacion_detalle = "SELECT * FROM certificaciones WHERE idsolicitud_certificacion = $_GET[formato]";
          ...
          while($row_certificacion = mysql_fetch_assoc($certificacion_detalle)){
            ...
            <tr class="text-center">
              ...
              <td><input type="text" class="form-control" name="ano_inicial[$contador]" id="exampleInputEmail1" placeholder="AÑO INICIAL" value="<?echo $row_certificacion['ano_inicial']?>" readonly></td>
      ...
      <?php } ?>
		...
		<tr>
          ...
          <?php 
          $query_producto_detalle = "SELECT * FROM productos WHERE idsolicitud_certificacion = $_GET[formato]";
		...
		<tr>
			...
			<td colspan="2">
				...
				<input type="text" class="form-control" name="responsable" value="<?echo $row_solicitud['responsable']?>" readonly>
				<?}else{?>
				En Proceso
				<?}?>
			</td>
    ...
    <tr>
      <td colspan="2">
        Nombre OC que recibe la solicitud:
      </td>
      <td colspan="2">
