...
if (isset($_POST['insertarObjecion']) && $_POST['insertarObjecion'] == "periodoObjecion") {
 ...
 /*     $queryOPP = "SELECT email FROM opp";
      $ejecutarOPP = mysql_query($query,$dspp) or die(mysql_error());

      $destinatarioOPP = "";
      while($emailOPP = mysql_fetch_assoc($ejecutarOPP)){
        if(!empty($emailOPP['email'])){
      ...
      while($emailOPP = mysql_fetch_assoc($ejecutar)){
        if(!empty($emailOPP['email'])){
          ...
          ';
             ...
             /* $destinatarioCert = "cert@spp.coop";
              $asunto = "D-SPP - Certificación para Organizaciones de Pequeños Productores"; 
          ...
          ';
              ...
              mail($destinatarioCert,$asunto,$cuerpo,$headers) ;
      ...
      <body>
        ...
        <table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
          <tbody>
            ...
            <tr>
              <td><b>Se ha iniciado el período de objeción, sera notificado una vez que finalice el mismo.</b></td>
            </tr>
