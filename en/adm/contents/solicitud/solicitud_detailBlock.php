    ...
    <div class="alert alert-danger" role="alert"><b>Se ha denegado la solicitud</b></div>
      ...
      <form action="<?php echo $editFormAction; ?>" name="form2" method="post">
          <div class="form-group has-error">
            <textarea type="text" class="form-control" id="inputError1" name="observaciones" placeholder="Puntos por los cuales no se pudo aprobar la solicitud"></textarea>
          </div>  
...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
            ...
            if($posicion_coincidencia === false){
              ...
              echo "PRODUCCIÓN <input name='op_resp4[]' type='checkbox' value='PRODUCCIÓN' checked readonly>";
            } 
          ?>
...
$posicion_coincidencia = strpos($texto, $cadena_buscada);
        ...
        <?php
          if($row_solicitud['op_resp12'] == 'SI'){
            echo "<div class='col-xs-6'>";
              echo "SI <input type='radio' name='op_resp12' onclick='mostrar_ventas()' id='op_resp12' value='SI' checked readonly>";
            echo "</div>";
            echo "<div class='col-xs-6'>";
              echo "NO <input type='radio' name='op_resp12' onclick='ocultar_ventas()' id='op_resp12' value='NO' readonly>";
            echo "</div>";
          }
          else if($row_solicitud['op_resp12'] == 'NO'){
            echo "<div class='col-xs-6'>";
              echo "SI <input type='radio' name='op_resp12' onclick='mostrar_ventas()' id='op_resp12' value='SI' readonly>";
            echo "</div>";
            echo "<div class='col-xs-6'>";
              echo "NO <input type='radio' name='op_resp12' onclick='ocultar_ventas()' id='op_resp12' value='NO' checked readonly>";
            echo "</div>";            
          }else{
             echo "<div class='col-xs-6'>";
              echo "SI <input type='radio' name='op_resp12' onclick='mostrar_ventas()' id='op_resp12' value='SI' readonly>";
    ...
    <tr >
      <td colspan="4">
        ...
        if(empty($row_solicitud['op_resp13'])){ ?>
            <tr>
              ...
              <td colspan="2"><input type="radio" name="op_resp13" class="form-control" id="ver" onclick="ocultar()" value="HASTA $3,000 USD" readonly></td>

            </tr>
            <tr>
              <td colspan="2">Entre $3,000 y $10,000 USD</td>
              <td colspan="2"><input type="radio" name="op_resp13" class="form-control" id="ver" onclick="ocultar()" value="ENTRE $3,000 Y $10,000 USD" readonly></td>
            </tr>
            <tr>
              <td colspan="2">Entre $10,000 a $25,000 USD</td>
              <td colspan="2"><input type="radio" name="op_resp13" class="form-control"  id="ver" onclick="ocultar()" value="ENTRE $10,000 A $25,000 USD" readonly></td>
            </tr>
            <tr>
              <td colspan="2">Más de $25,000 USD <sup>*</sup><br><h6><sup>*</sup>Especifique la cantidad.</h6></td>
              <td colspan="2"><input type="radio" name="op_resp13" class="form-control" id="exampleInputEmail1" onclick="mostrar()" value="mayor" readonly>
                <input type="text" name="op_resp13_1" class="form-control" id="oculto" style='display:none;' placeholder="Especifique la Cantidad" readonly>
              </td>
            </tr>
        <?php }else{?>
            ...
            <td colspan="2">
              <?php 
                if($row_solicitud['op_resp13'] == "HASTA $3,000 USD"){
                  echo "<input type='radio' name='op_resp13' class='form-control' id='ver' onclick='ocultar()' value='HASTA $3,000 USD' checked readonly>";
                }
               ?>
            </td>
            ...
            <td colspan="2">
              <?php 
                if($row_solicitud['op_resp13'] == "ENTRE $3,000 Y $10,000 USD"){
                  echo "<input type='radio' name='op_resp13' class='form-control' id='ver' onclick='ocultar()' value='ENTRE $3,000 Y $10,000 USD' checked readonly>";
                }
               ?>
            </td>
          </tr>
            ...
            <td colspan="2">
              <?php 
                 if($row_solicitud['op_resp13'] == "ENTRE $10,000 A $25,000 USD"){
                  echo "<input type='radio' name='op_resp13' class='form-control'  id='ver' onclick='ocultar()' value='ENTRE $10,000 A $25,000 USD' checked readonly>";
                }
               ?>
            </td>
          </tr>
            ...
            <td colspan="2">
              <?php 
                if($row_solicitud['op_resp13'] != "HASTA $3,000 USD" && $row_solicitud['op_resp13'] != "ENTRE $3,000 Y $10,000 USD" && $row_solicitud['op_resp13'] != "ENTRE $10,000 A $25,000 USD"){
                  ...
                  echo "<input type='radio' name='op_resp13' class='form-control' id='exampleInputEmail1' onclick='mostrar()' value='mayor' checked readonly>
                        <input type='text' name='op_resp13_1' class='form-control' id='oculto' style='display:block;' placeholder='Especifique la Cantidad' value='$row_solicitud[op_resp13]' readonly>";
                }
               ?>
            </td>
          </tr>
      ...
      <?php if(strlen($row_solicitud["op_resp15"])==NULL){ ?>
        <td colspan="4">
            ...
            ?>
              ...
              <?php 
               ...
               ?>
						...
						<td>
							<input type="text" class="form-control" name="materia[$contador]" id="exampleInputEmail1" placeholder="Materia" value="<?echo $row_producto['materia']?>" readonly>
						</td>
						<td>
							<input type="text" class="form-control" name="destino[$contador]" id="exampleInputEmail1" placeholder="Destino" value="<?echo $row_producto['destino']?>" readonly>
						</td>
						<td>
              <?php 
    ...
    <tr class="success">
      <td colspan="2">Enviar cotización a <u style="color:red;"><?echo $row_opp['nombre'];?></u></td>
      <td colspan="2">
        <input type="file" name="cotizacion_opp">          
      </td>
    </tr>
    <?php }?>
    <?php if(empty($row_solicitud['cotizacion_adm'])){ ?>
    <tr class="success">
      <td colspan="2">Enviar cotización a <u style="color:red;">FUNDEPPO</u></td>
      <td colspan="2">
        <input type="file" name="cotizacion_adm">
      </td>
    </tr>
    <?php } ?>
...
<?php 
  if(empty($row_solicitud['cotizacion_opp']) || empty($row_solicitud['cotizacion_adm'])){
    if($row_solicitud['status'] == "REVISION"){
 ?>
