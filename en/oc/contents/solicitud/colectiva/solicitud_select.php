...
if(isset($_POST['cancelar']) && $_POST['cancelar'] == "cancelar"){
  ...
  $updateSQL = "UPDATE solicitud_colectiva SET status = $estatus_interno WHERE idsolicitud_colectiva = $idsolicitud_colectiva";
...
if(isset($_POST['reemplazar_cotizacion']) && $_POST['reemplazar_cotizacion'] == 1){
  ...
  if(!empty($_FILES['nueva_cotizacion']['name'])){
      $_FILES["nueva_cotizacion"]["name"];
        ...
        $updateSQL = sprintf("UPDATE solicitud_colectiva SET cotizacion_opp = %s WHERE idsolicitud_colectiva = %s",
          GetSQLValueString($archivo, "text"),
          GetSQLValueString($idsolicitud_colectiva, "int"));
        $actualizar = mysql_query($updateSQL, $dspp) or die(mysql_error());

        $row_opp = mysql_query("SELECT opp.nombre, opp.abreviacion AS 'abreviacion_opp', opp.pais AS 'opp_pais', opp.spp, opp.password, opp.email, oc.email1, oc.email2, oc.abreviacion AS 'abreviacion_oc', oc.pais AS 'pais_oc', solicitud_colectiva.contacto1_email, solicitud_colectiva.contacto2_email, solicitud_colectiva.adm1_email FROM opp INNER JOIN solicitud_colectiva ON opp.idopp = solicitud_colectiva.idopp INNER JOIN oc ON solicitud_colectiva.idoc = oc.idoc WHERE idsolicitud_colectiva = $idsolicitud_colectiva", $dspp) or die(mysql_error());
...
if(isset($_POST['guardar_proceso']) && $_POST['guardar_proceso'] == 1){
  ...
  $query_opp = mysql_query("SELECT solicitud_colectiva.idopp, solicitud_colectiva.idoc, solicitud_colectiva.contacto1_email, solicitud_colectiva.contacto2_email, solicitud_colectiva.adm1_email, opp.nombre, opp.abreviacion AS 'abreviacion_opp', opp.email FROM solicitud_colectiva INNER JOIN opp ON solicitud_colectiva.idopp = opp.idopp WHERE solicitud_colectiva.idsolicitud_colectiva = $_POST[idsolicitud_colectiva]", $dspp) or die(mysql_error());
  $detalle_opp = mysql_fetch_assoc($query_opp);

  $row_informacion = mysql_query("SELECT solicitud_colectiva.idopp, solicitud_colectiva.idoc, oc.email1 AS 'oc_email1', oc.email2 AS 'oc_email2', solicitud_colectiva.contacto1_email, opp.nombre AS 'nombre_opp', opp.abreviacion AS 'abreviacion_opp', opp.email FROM solicitud_colectiva INNER JOIN opp ON solicitud_colectiva.idopp = opp.idopp INNER JOIN oc ON solicitud_colectiva.idoc = oc.idoc WHERE idsolicitud_colectiva = $_POST[idsolicitud_colectiva]", $dspp) or die(mysql_error());
  ...
  if($_POST['estatus_interno'] == 8){ //checamos si el estatus_interno es positvo
    ...
    if($_POST['tipo_solicitud'] == 'RENOVACION'){
      ...
      $updateSQL = sprintf("UPDATE solicitud_colectiva SET estatus_interno = %s, estatus_dspp = %s WHERE idsolicitud_colectiva = %s",
        GetSQLValueString($_POST['estatus_interno'], "int"),
        GetSQLValueString($estatus_dspp, "int"),
        GetSQLValueString($_POST['idsolicitud_colectiva'], "int"));
      $actualizar = mysql_query($updateSQL, $dspp) or die(mysql_error());

      $insertSQL = sprintf("INSERT INTO proceso_certificacion (idsolicitud_colectiva, estatus_interno, estatus_dspp, nombre_archivo, accion, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s, %s, %s)",
        GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
        GetSQLValueString($_POST['estatus_interno'], "int"),
        GetSQLValueString($estatus_dspp, "int"),
      ...
      $insertSQL = sprintf("INSERT INTO membresia(estatus_membresia, idopp, idsolicitud_colectiva, idcomprobante_pago) VALUES (%s, %s, %s, %s)",
   ...
   //***************************************************************************************************/
    ...
    ///*********************************                                     *********************************************
      /*09_04_2017$updateSQL = sprintf("UPDATE solicitud_colectiva SET estatus_interno = %s, estatus_dspp = %s WHERE idsolicitud_colectiva = %s",
        GetSQLValueString($_POST['estatus_interno'], "int"),
        GetSQLValueString($estatus_dspp, "int"),
        GetSQLValueString($_POST['idsolicitud_colectiva'], "int"));
      $actualizar = mysql_query($updateSQL, $dspp) or die(mysql_error());
...
if(isset($_POST['cargar_documentos']) && $_POST['cargar_documentos'] == 1){
  ...
  $insertSQL = sprintf("INSERT INTO formato_evaluacion (idopp, idsolicitud_colectiva, estatus_formato, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['idopp'], "int"),
    GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
  ...
  $insertSQL = sprintf("INSERT INTO proceso_certificacion (idsolicitud_colectiva, estatus_dspp, nombre_archivo, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
    GetSQLValueString($estatus_dspp, "int"),
    GetSQLValueString($nombre_archivo, "text"),
    GetSQLValueString($formato, "text"),
  ...
  $insertSQL = sprintf("INSERT INTO informe_evaluacion (idopp, idsolicitud_colectiva, estatus_informe, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['idopp'], "int"),
    GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
  ...
  $insertSQL = sprintf("INSERT INTO dictamen_evaluacion(idopp, idsolicitud_colectiva, estatus_dictamen, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['idopp'], "int"),
    GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
  ...
  $row_informacion = mysql_query("SELECT solicitud_colectiva.idsolicitud_colectiva, opp.nombre AS 'nombre_opp', opp.abreviacion AS 'abreviacion_opp', oc.nombre AS 'nombre_oc' FROM solicitud_colectiva INNER JOIN opp ON solicitud_colectiva.idopp = opp.idopp INNER JOIN oc ON solicitud_colectiva.idoc = oc.idoc WHERE idsolicitud_colectiva = $_POST[idsolicitud_colectiva]", $dspp) or die(mysql_error());
  $informacion = mysql_fetch_assoc($row_informacion);
...
if(isset($_POST['enviar_certificado']) && $_POST['enviar_certificado'] == 1){
  ...
  $insertSQL = sprintf("INSERT INTO certificado(idopp, idsolicitud_colectiva, entidad, estatus_certificado, vigencia_inicio, vigencia_fin, archivo, fecha_registro) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['idopp'], "int"),
    GetSQLValueString($_POST['idsolicitud_colectiva'], "int"),
...
//$query = "SELECT solicitud_colectiva.idsolicitud_colectiva AS 'idsolicitud', solicitud_colectiva.tipo_solicitud, solicitud_colectiva.idopp, solicitud_colectiva.idoc, solicitud_colectiva.fecha_registro, solicitud_colectiva.fecha_aceptacion, solicitud_colectiva.cotizacion_opp, solicitud_colectiva.contacto1_email, solicitud_colectiva.contacto2_email, opp.nombre AS 'nombre_opp', opp.abreviacion AS 'abreviacion_opp', opp.email, proceso_certificacion.idproceso_certificacion, proceso_certificacion.estatus_publico, proceso_certificacion.estatus_interno, proceso_certificacion.estatus_dspp, estatus_publico.nombre AS 'nombre_publico', estatus_interno.nombre AS 'nombre_interno', estatus_dspp.nombre AS 'nombre_dspp', periodo_objecion.*, membresia.idmembresia, membresia.estatus_membresia, contratos.idcontrato, contratos.estatus_contrato, certificado.idcertificado, formato_evaluacion.idformato_evaluacion, dictamen_evaluacion.iddictamen_evaluacion, informe_evaluacion.idinforme_evaluacion FROM solicitud_colectiva INNER JOIN opp ON solicitud_colectiva.idopp = opp.idopp LEFT JOIN proceso_certificacion ON solicitud_colectiva.idsolicitud_colectiva = proceso_certificacion.idsolicitud_colectiva LEFT JOIN estatus_publico ON proceso_certificacion.estatus_publico = estatus_publico.idestatus_publico LEFT JOIN estatus_interno ON proceso_certificacion.estatus_interno = estatus_interno.idestatus_interno LEFT JOIN estatus_dspp ON proceso_certificacion.estatus_dspp = estatus_dspp.idestatus_dspp LEFT JOIN periodo_objecion ON solicitud_colectiva.idsolicitud_colectiva = periodo_objecion.idsolicitud_colectiva LEFT JOIN membresia ON solicitud_colectiva.idsolicitud_colectiva = membresia.idsolicitud_colectiva LEFT JOIN contratos ON solicitud_colectiva.idsolicitud_colectiva = contratos.idsolicitud_colectiva LEFT JOIN certificado ON solicitud_colectiva.idopp = certificado.idopp LEFT JOIN dictamen_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = dictamen_evaluacion.idsolicitud_colectiva LEFT JOIN informe_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = informe_evaluacion.idsolicitud_colectiva LEFT JOIN formato_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = formato_evaluacion.idsolicitud_colectiva WHERE solicitud_colectiva.idoc = $idoc GROUP BY proceso_certificacion.estatus_dspp ORDER BY proceso_certificacion.estatus_dspp DESC";

$query = "SELECT solicitud_colectiva.*, solicitud_colectiva.idopp, solicitud_colectiva.idsolicitud_colectiva AS 'idsolicitud', oc.abreviacion AS 'abreviacionOC', opp.nombre AS 'nombre_opp', opp.abreviacion AS 'abreviacion_opp', opp.email, opp.estatus_opp, periodo_objecion.idperiodo_objecion, periodo_objecion.fecha_inicio, periodo_objecion.fecha_fin, periodo_objecion.estatus_objecion, periodo_objecion.observacion, periodo_objecion.dictamen, periodo_objecion.documento, membresia.idmembresia, certificado.idcertificado, contratos.idcontrato, contratos.estatus_contrato, informe_evaluacion.idinforme_evaluacion, formato_evaluacion.idformato_evaluacion, dictamen_evaluacion.iddictamen_evaluacion FROM solicitud_colectiva INNER JOIN oc ON solicitud_colectiva.idoc = oc.idoc INNER JOIN opp ON solicitud_colectiva.idopp = opp.idopp LEFT JOIN periodo_objecion ON solicitud_colectiva.idsolicitud_colectiva  = periodo_objecion.idsolicitud_colectiva LEFT JOIN membresia ON solicitud_colectiva.idsolicitud_colectiva = membresia.idsolicitud_colectiva LEFT JOIN certificado ON solicitud_colectiva.idsolicitud_colectiva = certificado.idsolicitud_colectiva LEFT JOIN contratos ON solicitud_colectiva.idsolicitud_colectiva = contratos.idsolicitud_colectiva LEFT JOIN informe_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = informe_evaluacion.idsolicitud_colectiva LEFT JOIN formato_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = formato_evaluacion.idsolicitud_colectiva LEFT JOIN dictamen_evaluacion ON solicitud_colectiva.idsolicitud_colectiva = dictamen_evaluacion.idsolicitud_colectiva WHERE solicitud_colectiva.idoc = $idoc GROUP BY solicitud_colectiva.idsolicitud_colectiva  ORDER BY solicitud_colectiva.fecha_registro DESC";
  ...
  <div class="col-md-12">
    <table class="table table-condensed table-bordered" style="font-size:12px;">
      <thead>
        <tr class="success">
          ...
          <th class="text-center">
            <a href="#" data-toggle="tooltip" title="Certification Entity"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>CE</a>
          </th>
          <th class="text-center">Organization</th>
          <th class="text-center">Application status</th>
          <th class="text-center">Quote <br>(downloable)</th>
          <th class="text-center">Objection process</th>
          <th class="text-center"><a href="#" data-toggle="tooltip" title="The CE must update the status of the process by choosing one of the options displayed in this section"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>Process of<br>Certification</a></th>
      ...
      while($solicitud = mysql_fetch_assoc($row_solicitud)){
          $query_proceso = "SELECT proceso_certificacion.*, proceso_certificacion.idsolicitud_colectiva, estatus_publico.idestatus_publico, estatus_publico.nombre AS 'nombre_publico', estatus_interno.idestatus_interno, estatus_interno.nombre AS 'nombre_interno', estatus_dspp.idestatus_dspp, estatus_dspp.nombre AS 'nombre_dspp', membresia.idmembresia, membresia.estatus_membresia, membresia.idcomprobante_pago, membresia.fecha_registro FROM proceso_certificacion LEFT JOIN estatus_publico ON proceso_certificacion.estatus_publico = estatus_publico.idestatus_publico LEFT JOIN estatus_interno ON proceso_certificacion.estatus_interno = estatus_interno.idestatus_interno LEFT JOIN estatus_dspp ON proceso_certificacion.estatus_dspp = estatus_dspp.idestatus_dspp LEFT JOIN membresia ON proceso_certificacion.idsolicitud_colectiva = membresia.idsolicitud_colectiva WHERE proceso_certificacion.idsolicitud_colectiva =  $solicitud[idsolicitud] ORDER BY proceso_certificacion.idproceso_certificacion DESC LIMIT 1";
      ...
      ?>
        <tr <?php if($proceso_certificacion['estatus_dspp'] == 12){ echo "class='success'"; }else if($proceso_certificacion['estatus_interno'] == 9){ echo "class='danger'"; } ?>>
          <td>
            ...
            <input type="hidden" name="idsolicitud_colectiva" value="<?php echo $solicitud['idsolicitud']; ?>">
          ...
          <td>
            ...
            ?>
              <div class="btn-group" role="group" aria-label="...">
                <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="<?php echo "#cotizacion".$solicitud['idsolicitud_colectiva']; ?>" title="Replace quote"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
                <a href='<?php echo $solicitud['cotizacion_opp']; ?>' class='btn btn-sm btn-success' style='font-size:12px;color:white;height:30px;' target='_blank'><span class='glyphicon glyphicon-download' aria-hidden='true'></span> Download quote</a>
              </div>
            <?php
            ...
            <!-- Modal -->
            <div class="modal fade" id="<?php echo "cotizacion".$solicitud['idsolicitud_colectiva']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <form action="" method="POST" enctype="multipart/form-data">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <h4 class="modal-title" id="myModalLabel">Replace actual quote</h4>
                    </div>
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="nueva_cotizacion">New quote</label>
                        ...
                        <input type="hidden" name="idsolicitud_colectiva" value="<?php echo $solicitud['idsolicitud_colectiva']; ?>">
                      </div>
                    </div>

                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                      <button type="submit" name="reemplazar_cotizacion" value="1" class="btn btn-primary">Replace quote</button>
                    </div>                    
          ...
          <td>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              ?>
                <button type="button" class="btn btn-sm btn-primary" style="width:100%" data-toggle="modal" data-target="<?php echo "#certificacion".$solicitud['idsolicitud_colectiva']; ?>">Process of Certification</button>

                <!-- inicia modal proceso de certificación -->
                <div id="<?php echo "certificacion".$solicitud['idsolicitud_colectiva']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body"><!-- INICIA MODAL BODY -->
                        <div class="row"><!--INICIA ROW-->
                          ...
                          $row_proceso_certificacion = mysql_query("SELECT proceso_certificacion.*, estatus_interno.nombre_ingles FROM proceso_certificacion INNER JOIN estatus_interno ON proceso_certificacion.estatus_interno = estatus_interno.idestatus_interno WHERE proceso_certificacion.idsolicitud_colectiva = '$solicitud[idsolicitud]' AND proceso_certificacion.estatus_interno IS NOT NULL", $dspp) or die(mysql_error());
                          ...
                          <div class="col-md-12">
                            <select class="form-control" name="estatus_interno" id="<?php echo 'statusSelect'.$solicitud['idsolicitud']; ?>" onchange="<?php echo 'funcionSelect'.$solicitud['idsolicitud'].'()'; ?>">
                              <option value="">Select the process in which you are</option>
                              <?php 
                          ...
                          ?>
                              ...
                              <div class="col-xs-12" id="<?php echo 'divSelect'.$solicitud['idsolicitud']; ?>" style="margin-top:10px;">
                                ...
                                <div class="col-md-12">
                                  <textarea id="<?php echo 'registroOculto'.$solicitud['idsolicitud']; ?>" style="display:none" name="mensaje_negativo" class="form-control textareaMensaje" cols="30" rows="10" placeholder="Writte here"></textarea>  
                                </div>
                              ...
                              <div id="<?php echo 'tablaCorreo'.$solicitud['idsolicitud']; ?>" style="display:none"> 
                                <div class="col-xs-12"  style="margin-top:10px;">
                                  ...
                                  ?>
                                    ...
                                    <div class="col-xs-12">
                                      <div class="col-xs-12">
                                        <h4 style="font-size:14px;">ATTACHED FILES( <small>Attachments within the email</small> )</h4>
                                        <?php 
                                          echo '<h5 style="font-size:12px;" class="alert alert-warning">
                                          <ul>
                                            <li>This Organization is in the "Certificate Renewal Process", therefore "Contract of Use" will not be sent.</li>
                                    ...
                                    <div class="col-xs-12">
                                      <div class="col-xs-12">
                                        ...
                                        <p class="alert alert-warning">
                                          <strong>
                                            Select the language in which you want to send the <span style="color:red">SPP Manual, Use Agreement and Acknowledgment of Receipt</span>:
                                      ...
                                      <div class="col-xs-12">
                                        <h4 style="font-size:14px;">EXTRA FILE: <span style="color:#7f8c8d">Attach another file if necessary.</span></h4>
                                        <input type="text" class="form-control" name="nombre_archivo_dictamen" placeholder="File name">
                                        <input type="file" class="form-control" name="archivo_dictamen">
                                        <hr>
                                      </div>
                              ...
                              <div id="<?php echo 'tabla_negativo'.$solicitud['idsolicitud_colectiva']; ?>" style="display:none"> 
                                <div class="col-xs-12"  style="margin-top:10px;">
                                  <?php 
                                  if($solicitud['tipo_solicitud'] == 'RENOVACION'){
                                  ?>
                                    <p class="alert alert-info">
                                      The following format will be sent shortly to the SPO: <?php echo $proceso_certificacion['idsolicitud_colectiva'] ?>
                                    </p>
                                    <div class="col-xs-12">
                                      ...
                                      <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6">
                                          ...
                                          <p>To: <span style="color:red"><?php echo $solicitud['nombre_opp']; ?></span></p>
                                          <p>Email(s): <?php echo $solicitud['contacto1_email']." ".$solicitud['contacto2_email']." ".$solicitud['email']; ?></p>
                                          <p>Email subject: <span style="color:red">Notification of the Opinion - SPP</span></p>
                                  ...
                                  ?>
                                    <p class="alert alert-info">
                                      The following format will be sent shortly to the OPP: <?php echo $proceso_certificacion['idsolicitud_colectiva'] ?>
                                    </p>
                                    <div class="col-xs-12">
                      ...
                      <div class="modal-footer">
                        ...
                        ?>
                        <button type="submit" class="btn btn-success" style="width:100%" id="<?php echo 'boton1'.$solicitud['idsolicitud_colectiva']; ?>" name="guardar_proceso" value="1">Save process</button>
                        <?php 
                        if($solicitud['tipo_solicitud'] == 'RENOVACION'){
                        ?>
                        <button type="submit" class="btn btn-success" id="<?php echo 'boton2'.$solicitud['idsolicitud_colectiva']; ?>" name="guardar_proceso" value="1" onclick="return validarRenovacion()" style="width:100%; display:none" >Send opinion</button>
                        <?php
                        }else{
                        ?>
                        <button type="submit" class="btn btn-success" id="<?php echo 'boton2'.$solicitud['idsolicitud_colectiva']; ?>" name="guardar_proceso" value="1" onclick="return validar()" style="width:100%; display:none" >Send opinion</button>
                        <?php
                        }
                         ?>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            if($solicitud['tipo_solicitud'] == 'RENOVACION'){
                              ...
                              if(isset($proceso_certificacion['estatus_membresia'])){  
                                ...
                                ?>
                                  <p class="alert alert-info">Please load the following documents:</p>
                                  <p class="alert alert-info">
                                ...
                                echo "<p class='alert alert-danger'>Membership has not yet been approved</p>";
                              }
                            }else{
                              ...
                              if(isset($proceso_certificacion['estatus_membresia'])){
                                ...
                                if(!isset($solicitud['idcontrato'])){
                                  echo "<p class='alert alert-danger'>The Use Contract has not been loaded yet</p>";
                                }else{
                                  echo "<p class='alert alert-warning'>The Use Contract has not yet been approved</p>";
                                }
                          ...
                          <div class="col-md-6">
                            <h4 style="font-size:14px;">Updload certificate</h4>
                            <?php 
                            if(isset($solicitud['iddictamen_evaluacion']) && isset($solicitud['idformato_evaluacion']) && isset($solicitud['idinforme_evaluacion'])){
                                ...
                                if($solicitud['tipo_solicitud'] == 'RENOVACION'){ // EN CASO DE QUE SEA UNA SOLICITUD EN RENOVACIÓN
                                  ...
                                  if(($formato['estatus_formato'] == 'ACEPTADO' && $informe['estatus_informe'] == 'ACEPTADO' && $dictamen['estatus_dictamen'] == 'ACEPTADO')){
                                    ...
                                    ?>
                                      <p class="alert alert-info">The certificate has been uploaded, which has a validity from: <b><?php echo date('d/m/Y', $inicio); ?></b> to: <b><?php echo date('d/m/Y', $fin); ?></b></p>
                                      <a href="<?php echo $certificado['archivo']; ?>" class="btn btn-success" style="width:100%" target="_blank">Download certificate</a>
                                    <?php
                                    }else{
                                    ?>
                                      <div class="col-md-12">
                                        <p class="alert alert-info">Please define the Start and End date of the Certificate.</p>
                                        <p class="alert alert-warning" style="padding:5px;">In case the calendar is not displayed, please define the date with the following format <span style="color:red">dd-mm-yyyy</span></p>
                                      </div>
                                      <div class="col-md-6">
                                        <label for="fecha_inicio">Start date</label> 
                                        <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" placeholder="dd-mm-yyyy" required> 
                                      </div>
                                      <div class="col-md-6">
                                        <label for="fecha_fin">End date</label>
                                        <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" placeholder="dd-mm-yyyy" required>
                                      </div>
                                    ...
                                    Once the necessary documentation has been approved by SPP Global, you can upload the SPP Certificate.
                                    </p> ';
                                  }
                                  // termina validación //
                                  ...
                                  if(($formato['estatus_formato'] == 'ACEPTADO' && $informe['estatus_informe'] == 'ACEPTADO' && $dictamen['estatus_dictamen'] == 'ACEPTADO') && ($solicitud['estatus_contrato'] == 'ACEPTADO')){
                                    ...
                                    echo '<p class="alert alert-warning">
                                    Once the "Use Agreement" is approved, you can upload the corresponding Certificate.
                                    </p> ';
                                  }
                                  // termina validación //
                                }
                              ...
                              if($solicitud['tipo_solicitud'] == 'RENOVACION'){
                                echo '<p class="alert alert-warning">
                                  The evaluation documents have not yet been loaded.
                                </p> ';
                              }else{
                                echo '<p class="alert alert-warning">
                                  Once the necessary documentation has been approved by SPP Global, you can upload the SPP Certificate.
          ...
          <td>
            <a class="btn btn-sm btn-primary" data-toggle="tooltip" title="Consult application" href="?SOLICITUD&IDsolicitud_colectiva=<?php echo $solicitud['idsolicitud']; ?>">View application</a>
          </td>
          <td>
