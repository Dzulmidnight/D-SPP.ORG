			...
			<div class="col-lg-12">
				<table class="table table-bordered" id="tablaProductos">
					...
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="volumen_terminado[0]" id="exampleInputEmail1" placeholder="Volumen Finished">
						</td>

						<td>
							<input type="text" class="form-control" name="volumen_materia[0]" id="exampleInputEmail1" placeholder="Volumen of Material">
						</td>
						<td>
							<input type="text" class="form-control" name="origen[0]" id="exampleInputEmail1" placeholder="Origin">
						</td>
						<td>
