...
<html lang="es">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-6">
        <p class="alert alert-default" style="padding:9px;"><a href="lista_opp.php"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Check the list of Small Producers' Organizations certified with the SPP here.</a></p>
      </div>
      <div class="col-md-6">
        <p class="alert alert-success" style="padding:9px;"><a href="lista_empresas.php"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Check the list of companies registered with the SPP here.</a></p>
      </div>
      <div class="col-md-12">
        <div class="row">
          ...
          <thead>
             <tr>
               <td colspan="12" class="info">
                ...
                <h4 style="font-size:13px;text-align:center">NOTA: <span style="color:#e74c3c">IT IS THE RESPONSIBILITY OF INTERESTED REVISE THE SPECIFIC STATUS IN WHICH IS THE COMPANY</span></h4>
              </td>
             </tr>
