...
if (isset($_POST['actualizarStatus']) && $_POST['actualizarStatus'] == "actualizarStatus") {
    ...
    /*while($datos_anexos = mysql_fetch_assoc($row_anexos)){
      $anexoNombres .= "<p><i class='fa fa-check-circle-o fa-2x'></i><a href=http://d-spp.com/".utf8_decode($datos_anexos['archivo']).">".$datos_anexos['anexo']."</a></p>";
    }*/
...
*/
      ...
      //AL NOMBRE DEL ARCHIVO(FORMATO) LE CONCATENO EL TIME
       /* $rutaArchivo = "formatos/anexos/";
        ...
        $mail->Host = 'mail.d-spp.com';
          
        // Usuario y contraseña para autenticación en el servidor
         
        $mail->Username   = "soporte@d-spp.com";
         
        $mail->Password = "/aung5l6tZ";


        $mail->From = "soporte@d-spp.com";
     ...
     $mail->SMTPDebug  = 1;
       ...
       /*19/04 $mail->IsSMTP();
        ...
        $mail->Port = 25;
        $mail->SMTPSecure = "ssl";
        $mail->Host = "server131.neubox.net";
        $mail->Username = "soporte@d-spp.com";
        $mail->Password = "/aung5l6tZ";
        $mail->From = "soporte@d-spp.com";
        $mail->FromName = "CERT - DSPP";
        ...
        $mensaje = '
          ...
          <body>
            <table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
              <tbody>
                <tr>
                  <th rowspan="2" scope="col" align="center" valign="middle" width="170"><img src="http://d-spp.com/img/mailFUNDEPPO.jpg" alt="Simbolo de Pequeños Productores." width="120" height="120" /></th>
            ...
            $cuerpo = '
              ...
              <body>
                ...
                <table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
                  <tbody>
                    <tr>
                      <th rowspan="3" scope="col" align="center" valign="middle" width="170"><img src="http://d-spp.com/img/mailFUNDEPPO.jpg" alt="Simbolo de Pequeños Productores." width="120" height="120" /></th>
                      <th scope="col" align="left" width="280"><strong>Notificación de Estado / Status Notification ('.$fecha.')</strong></th>
                    </tr>
                    <tr>
                      <td>Se ha cargado su certificado dentro del sistema, por favor proceda a realizar el pago correspondiente a la membresia, después de realizar el pago subir el comprobante a nuestra plataforma dentro de su sesión de OPP <a href="http://d-spp.com/?OPP">www.d-spp.com/?OPP</a>, para poder realizarlo diríjase a la sección de "SOLICITUDES", en el apartado de "Certificación" podra realizar esté proceso.</td>
                    </tr>
 ...
 <!----------------------------------------- INICIA BOTON VER SOLICITUD ---------------------------------------------->
  ...
  <!----------------------------------------- INICIA SECCION COTIZACION OPP ---------------------------------------------->
            <td class="text-center" style="width:250px;">
              ...
              <a href="http://d-spp.com/oc/<?echo $row_opp['cotizacion_opp']?>" target="_blank" type="button" class="btn <?php if(empty($row_opp['cotizacion_opp'])){ echo 'btn-default btn-sm';}else{echo 'btn-success btn-sm';} ?>" aria-label="Left Align" <?php if(empty($row_opp['cotizacion_opp'])){echo "disabled";}?>>
  ...
  <!----------------------------------------- INICIA SECCIÓN COTIZACION FUNDEPPO ---------------------------------------------->
            <!--<td>
              <a href="http://d-spp.com/oc/<?echo $row_opp['cotizacion_adm']?>" target="_blank" type="button" class="btn <?php if(empty($row_opp['cotizacion_adm'])){ echo 'btn-danger btn-sm';}else{echo 'btn-success btn-sm';} ?>" aria-label="Left Align" <?php if(empty($row_opp['cotizacion_adm'])){echo "disabled";}?>>
  ...
  <!----------------------------------------- INICIA SECCIÓN DICTAMEN OBJECIÓN ---------------------------------------------->
            <td class="text-center">
              ...
              if(isset($registroObjecion['dictamen'])){
                echo "<p>Dictamen</p> <span style='padding:7px;' class='alert alert-danger'>$registroObjecion[dictamen]</span></p>";
                echo "<a class='btn btn-sm btn-success' href='http://d-spp.com/adm/$registroObjecion[adjunto]' target='_blank'>Descargar</a>";
              }
               ?>
            </td>
                                ...
                                <div id="tablaCorreo" style="display:none">
                                  <div class="col-xs-12"  style="margin-top:10px;">
                                    ...
                                    <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-12">
                                        <div class="col-xs-6"><img src="http://d-spp.com/img/mailFUNDEPPO.jpg" alt="Simbolo de Pequeños Productores." width="120" height="120" /></div>
                                        <div class="col-xs-6">
