...
if(isset($_POST['opp_propuesta'])){
      ...
      /********************************************************************************/
        ...
        $asunto = "D-SPP - Certificación para Organizaciones de Pequeños Productores / Certification for Small Producers' Organizations";
        ...
        if($_POST['propuesta_txt'] == 18){   /******************************** EL OPP HA ACEPTADO LA PROPUESTA ************************************************/
              ...
              <body>
                ...
                <table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="color:#ff738a;">Felicidades tu cotización fue aceptada, por favor ponerse en contacto con <b>'.$nombreOPP.'</b> para iniciar el proceso de renovación del certificado.</td>
                    </tr>
                    <tr>
                      <td align="left" style="color:#ff738a;">Congratulations your quote was accepted, please contact:  <b>'.$nombreOPP.'</b> to start the process of recertification.</td>
                    </tr>
                    ...
                    <tr>
                      <td align="left" style="color:#ff738a;">Nombre / Name: '.$nombreOPP1.' | '.$emailOPP1.'</td>
                    </tr>
                    <tr>
                      <td align="left" style="color:#ff738a;">Nombre / Name: '.$nombreOPP2.' | '.$emailOPP2.'</td>
                    </tr>
          ...
          /********************************************************************************/
            ...
            $asunto2 = "D-SPP - Renovación de Certificado para Organizaciones de Pequeños Productores / Renewal Certificate for Small Producers' Organizations"; 
            ...
            $estatusAceptado = 18;
            $updateSQL = "UPDATE solicitud_certificacion SET status = $estatusAceptado WHERE idsolicitud_certificacion != $_POST[idsolicitud] AND fecha_elaboracion = $fecha_elaboracion";
              ...
              <body>
                ...
                <table style="font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #797979;" border="0" width="650px">
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="color:#ff738a;">Felicidades su cotización fue aceptada, sera informado una vez que el período de objeción inicie, después podra ponerse en contacto con:</td>
                    </tr>
                    <tr>
                      <td align="left" style="color:#ff738a;">Congratulations your quote was accepted, you will be informed once the objection period starts, then you can contact:</td>
                    </tr>
          ...
          /********************************************************************************/
            ...
            $asunto2 = "D-SPP - Cotización de Certificación para Organizaciones de Pequeños Productores / Quote Certification for Small Producers' Organizations"; 
...
if(isset($_POST['formulario_contrato']) && $_POST['formulario_contrato'] == 1){
  ...
  $asunto = "D-SPP - Contrato de Uso SPP - Acuse de Recibido "; 
        ...
        if($mail->Send()){
          ...
          echo "<script>alert('Se han enviado los documentos correspondientes, sera notificado por correo una vez revisados / Have sent the relevant documents, you will be notified by mail once revised..');location.href ='javascript:history.back()';</script>";
        }else{
              echo "<script>alert('Error, no se pudo enviar el correo / Error, could not send mail');location.href ='javascript:history.back()';</script>";
    ...
    <table class="table table-bordered table-striped" style="font-size:12px">
      <thead>
        <tr>
          ...
          <th class="text-center">Membership SPP / Certificate</th>
...
<!-------------------------------- INICIA BOTON VER SOLICITUD ---------------------------------->
            <td>
              ...
              <?php
               ...
               ?>
                <a class="btn btn-sm btn-primary" style="width:100%" href="?SOLICITUD&amp;detailBlock&amp;idsolicitud=<?php echo $row_opp['idsolicitud_certificacion']; ?>&contact" aria-label="Left Align">
                  <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                  <?php echo  date("d/m/Y", $fecha); ?><br>View application
                </a>    
               <?php 
 ...
 <!-------------------------------- INICIA SECCIÓN ESTATUS ---------------------------------->
              <td>
                ...
                <?php }else if($row_opp['status'] != 1 && $row_opp['status'] != 2 && $row_opp['status'] != 3 && $row_opp['status'] != 14 && $row_opp['status'] != 15){?>
                    ...
                    <?php echo '<p class="alert alert-warning" style="padding:5px"><a  href="#" data-toggle="tooltip" title="'.$estatus_interno['descripcion_interna'].'">'.$estatus_interno['nombre'].'</a></p>'; ?>

                  <?php }else{ ?>

                    <?php echo '<p class="alert alert-warning" style="padding:5px"><a href="#" data-toggle="tooltip" title="'.$estatus_publico['descripcion_publica'].'">'.$estatus_publico['nombre'].'</a></p>'; ?>
  ...
  <!-------------------------------- INICIA SECCIÓN COTIZACIÓN ---------------------------------->
              <td class="text-center" style="width:150px;">
                <form action="" method="post">  
                  ...
                  ?>
                    <a class="btn btn-sm btn-success" href="<?echo $row_opp['cotizacion_opp']?>" target="_blank" type="button" data-toggle="tooltip" data-placement="top" title="Download Quote">
                  ...
                  <?php 
                   ...
                   <?php 
                    ...
                    ?>
                      <!-- PROPUESTA ACEPTADA -->
                      <button class="btn btn-sm btn-info" type="submit" name="propuesta_txt" data-toggle="tooltip" data-placement="top" title="Accept Quote" value="18">
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
                      </button>
                      
                      <!-- PROPUESTA RECHAZADA -->
                      <button class="btn btn-sm btn-danger" type="submit" name="propuesta_txt" data-toggle="tooltip" data-placement="top" title="Reject Quote" value="24">
                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 
                      </button>
                  ...
                  ?>
                      <button class="btn btn-sm btn-danger" type="submit" name="propuesta_txt" disabled>
                        ...
                        <input type="hidden" value="You have rejected the proposal" name="mensaje" />
                      </button>
  ...
  <!-------------------------------- INICIA SECCIÓN RESOLUCION DE OBJECION ---------------------------------->
              <td>
                ...
                if(isset($registroObjecion['dictamen'])){
                  echo "<p>Dictum</p> <span class='alert alert-info' style='padding:7px;'>$registroObjecion[dictamen]</span></p>";
                }
                 ?>
                <h6>
                                  ...
                                  <div class="col-xs-6 ">
                                      ...
                                      <?php if(empty($registroCertificado['idcertificado'])){ ?>
                                        <?php if($row_opp['status'] == 19){ ?>
                                          <div class="col-xs-12 alert alert-warning" role="alert">
                                            <div class="col-xs-12">
                                              Status Certificate: <strong>It has started the certification process.</strong>  
                                            </div>                                  
                                          </div>
                                        <?php }else{ ?>
                                          <div class="col-xs-12 alert alert-danger" role="alert">
                                            <div class="col-xs-12">
                                              Status Certificate: <strong>It has not started the certification process.</strong>  
                                            </div>                                  
                                          </div>
                                        <?php } ?>
                                      <?php }else{ ?>
                                        <div class="col-xs-12 alert alert-success" role="alert">
                                          <div class="col-xs-12">
                                            Certificate status update: <b><?echo date("d/m/Y", $registroCertificado['fecha']) ?></b>
                                          </div>
                                          <hr>
                                          <div class="col-xs-12 ">
                                          <?
                                      ...
                                      ?>
                                          ...
                                          <div class="col-xs-12 alert alert-warning">
                                            <div class="col-xs-12"><h4>Use Agreement</h4></div>
                                            <div class="col-xs-12">
                                              The SPP Use Agreement and the Acknowledgement Receipt loaded.
                                            </div>
                                      ...
                                      ?>
                                        <form action="" method="post" id="contrato_spp" enctype="multipart/form-data">
                                          <div class="col-xs-12 alert alert-warning">
                                            <div class="col-xs-12"><h4>Use Agreement</h4></div>
                                            <div class="col-xs-12">
                                              Please charge the SPP contract use, as well as the acknowledgment of receipt which must be duly signed.
                                            </div>
                                            <div class="col-xs-12">
                                              <input name="contrato_uso" type="file" class="filestyle" data-buttonName="btn-info" data-buttonBefore="true" data-buttonText="SPP contract" required>
                                            </div>
                                            <div class="col-xs-12">
                                              <input name="acuse_recibido" type="file" class="filestyle" data-buttonName="btn-info" data-buttonBefore="true" data-buttonText="Acknowledgment of receipt" required>
                                            </div>
                                            <div class="col-xs-12">
                                              <input type="submit" class="btn btn-success">
                                              <input type="hidden" name="idopp" value="<?php echo $row_opp['idopp'];?>">
                                              <input type="hidden" name="idoc" value="<?php echo $row_opp['idoc'];?>">
                                              <input type="text" name="idsolicitud_certificacion" value="<?php echo $row_opp['idsolicitud_certificacion'] ?>">
                                              <input type="text" name="formulario_contrato" value="1">
                                            </div>
                                          </div>
                                        </form>
                                      <?php
                                      ...
                                      ?>
                                          <div class="col-xs-12 alert alert-danger">
                                            <div class="col-xs-12"><h4>Use Agreement</h4></div>
                                            <div class="col-xs-12">
                                              Still it has not completed the certification process.
                                            </div>
                                          </div>
                                      <?php 
                                      }
                    ...
                    <form action="" method="post" id="pagoCertificado" enctype="multipart/form-data">
                                  <?php if($registroCertificado['statuspago'] == "APROBADO"){ ?>
                                    <div class="col-xs-6 alert alert-success">
                                      ...
                                      <p><strong>Congratulations !!! </strong> your membership has been accredited, from now may have its certificate.</p>
                                      </div>
                                      <div class="col-xs-12">
                                        <?php 
                                          if($registroCertificado['statuspago'] == "APROBADO"){
                                            echo "<div class='col-xs-6'><b><u>Certificate expired on: ".$registroCertificado['vigenciafin']."</u></b></div>";
                                          }
                                         ?>
                                  ...
                                  <?php }else if($registroCertificado['statuspago'] == "REVISION"){ ?>
                                    <div class="col-xs-6 alert alert-warning">
                                      <div class="col-xs-12">
                                      <p>Membership Status: <b><?if(empty($registroCertificado['statuspago'])){echo "No se ha realizado el pago";}else{echo $registroCertificado['statuspago'];}?></b></p>
