    ...
    <table class="table table-bordered" style="font-size:12px;">
      <thead>
        <tr class="success">
          ...
          <th class="text-center">SPP membership</th>
        ...
        if($total_solicitudes != 0){
            ...
            <tr>
              <td>
                <form action="../../reportes/solicitud.php" method="POST" target="_new">
                  <button class="btn btn-xs btn-default" data-toggle="tooltip" title="Download Quote" target="_new" type="submit" ><?php echo $solicitud['idsolicitud_colectiva']; ?> <img src="../../img/pdf.png" style="height:30px;" alt=""></button>
          ...
          <!--<form action="" method="POST" enctype="multipart/form-data">-->
              ...
              <td>
                ...
                if(isset($solicitud['idmembresia'])){
                ?>
                  <button type="button" class="btn btn-sm btn-primary" style="width:100%" data-toggle="modal" data-target="<?php echo "#certificado".$solicitud['idsolicitud_colectiva']; ?>">Consultar Certificado</button>
                <?php
                }else{
                ?>
              ...
              <td>
                <input type="hidden" name="tipo_solicitud" value="<?php echo $solicitud['tipo_solicitud']; ?>">
                <a class="btn btn-sm btn-primary" style="display:inline-block" href="?SOLICITUD&amp;detail&amp;idsolicitud_colectiva=<?php echo $solicitud['idsolicitud_colectiva']; ?>" data-toggle="tooltip" title="View application">
                  Consult application
                </a>
