...
<? if(isset($_GET['select'])){?> class="active" <? }?>>
	<a href="?SOLICITUD&select" aria-label="Left Align">
		<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Applications
	</a>
</li>
<li role="presentation"
<? if(isset($_GET['add'])){?> class="active" <? }?>>
	<a href="?SOLICITUD&add" aria-label="Left Align">
		<span class="glyphicon glyphicon-open-file" aria-hidden="true"></span> New Application
	</a>
</li>

<? if(isset($_GET['detail'])){?>
<li role="presentation" 
 class="active" ><a href="#">Detail</a></li>
<? }?>
