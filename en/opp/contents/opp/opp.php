<ul class="nav nav-pills">
	<li role="presentation" <?php if(isset($_GET['detail'])){ echo "class='active'"; } ?>>
		<a href="?OPP&detail"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> My Account</a>
	</li>

	<li role="presentation" <?php if(isset($_GET['contacts'])){ echo "class='active'"; } ?>>
		<a href="?OPP&contacts"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Contacts</a>
	</li>
</ul>
