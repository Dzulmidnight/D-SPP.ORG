...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) { // INICIA INSERCION DE SOLICITUD
 mysql_select_db($database_dspp, $dspp);
  ...
  header(sprintf("Location: %s", $insertGoTo));*/
echo "<script>window.location='main_menu.php?SOLICITUD&select&mensaje=Solicitud agregada correctamente, se ha notificado al OC por email.'</script>"; 
 		...
 		<tr>
 			<th>
	      		...
	      		<div class="col-xs-12">
			      	<select class="form-control" name="idocSelect" required>
						...
						<option value="99">FUNDEPPO( Todos )</option>
			        <?php 
 			...
 			<th class="danger">
	  	    	...
	  	    	<div class="col-xs-3">
	  	    		<div class="row">
		  	    		<div class="col-xs-12">
		  	    			<p style="font-size:12px;"><b>Renovación de Registro</b></p>	
		  	    		</div>
		  	    		<div class="col-xs-12">
 	...
 	<tbody>
		...
		<tr>
			<td colspan="2">
				...
				<div class="col-xs-6">
					<input type="text" class="form-control" name="adm1_nombre" placeholder="Nombre 1">
					<input type="email" class="form-control" name="adm1_correo" placeholder="Correo Electronico 1">
				</div>
				<div class="col-xs-6">

					<input type="text" class="form-control" name="adm1_telefono" placeholder="Telefono 1">
				</div>
				<div class="col-xs-12"><br></div>
				<div class="col-xs-6">
