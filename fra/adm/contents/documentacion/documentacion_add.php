...
if ((isset($_POST["agregar_documentacion"])) && ($_POST["agregar_documentacion"] == "1")) {
  ...
  if($_POST['idestatus_interno'] == 'GENERAL'){
  	$general = 1;
	  $insertSQL = sprintf("INSERT INTO documentacion (nombre, archivo, idioma, fecha_registro, general) VALUES (%s, %s, %s, %s, %s)",
	  	GetSQLValueString($_POST['nombre'], "text"),
	  	GetSQLValueString($archivo, "text"),
	  	GetSQLValueString($_POST['idioma'], "text"),
	  	GetSQLValueString($fecha, "int"),
	  	GetSQLValueString($general, "int"));
					...
					<tbody>
						...
						<form action="" method="POST">
						 	<tr>
						 		...
						 		<td>
						 			<?php 
						 			if(isset($documentacion['general'])){
						 				echo "GENERAL";
						 			}else{
						 				echo $documentacion['nombre_interno']; 
						 			}
						 			?>
						 		</td>
