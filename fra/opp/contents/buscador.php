		...
		<table class="table table-bordered table-condensed">
			...
			<tbody style="font-size:11px;">
				...
				?>
					<tr>
						<td>
							<button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="<?php echo "#datos".$opp['idopp']; ?>">Consultation des<br>informations générales</button>
