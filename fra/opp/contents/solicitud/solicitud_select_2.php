      ...
      /********************************************************************************/
        ...
        if($_POST['propuesta_txt'] == 18){   /******************************** EL OPP HA ACEPTADO LA PROPUESTA ************************************************/
          ...
          /********************************************************************************/
            ...
            $updateSQL = "UPDATE solicitud_certificacion SET status = $estatusDenegado WHERE idsolicitud_certificacion != $_POST[idsolicitud] AND fecha_registro = $fecha_registro";
         ...
         // INICIA EL ENVIO DE MENSAJE DE DENEGACIÓN MASIVA DE COTIZACIONES
          ...
          $ejecutar = mysql_query($queryMensaje,$dspp) or die(mysql_error());
            ...
            $query = "SELECT solicitud_certificacion.idsolicitud_certificacion, solicitud_certificacion.idopp, solicitud_certificacion.idoc, solicitud_certificacion.status, solicitud_certificacion.fecha_registro, solicitud_certificacion.cotizacion_opp, oc.idoc, oc.nombre, oc.email FROM solicitud_certificacion INNER JOIN oc ON solicitud_certificacion.idoc = oc.idoc WHERE idopp = $idopp AND status = $estatusDenegado AND fecha_registro = $fecha_registro AND cotizacion_opp != ''";
            $ejecutar = mysql_query($query,$dspp) or die(mysql_error());
...
if(isset($_GET['query'])){
  $query_opp = "SELECT opp.* ,solicitud_certificacion.*, oc.idoc AS 'idoc', oc.nombre AS 'nombreOC', oc.idoc, oc.email1 FROM solicitud_certificacion INNER JOIN opp ON solicitud_certificacion.idopp = opp.idopp INNER JOIN oc ON solicitud_certificacion.idoc = oc.idoc WHERE idsolicitud_certificacion = ".$_GET['query']." AND solicitud_certificacion.estatus_interno != 24 ORDER BY solicitud_certificacion.fecha_registro DESC";
  ...
  $query_opp = "SELECT opp.* ,solicitud_certificacion.*, oc.idoc AS 'idoc', oc.nombre AS 'nombreOC', oc.idoc, oc.email1 FROM solicitud_certificacion INNER JOIN opp ON solicitud_certificacion.idopp = opp.idopp INNER JOIN oc ON solicitud_certificacion.idoc = oc.idoc WHERE solicitud_certificacion.idopp = '".$_SESSION['idopp']."' AND solicitud_certificacion.estatus_interno != 24 ORDER BY solicitud_certificacion.fecha_registro DESC"; 

  #$query_opp = "SELECT opp.* ,solicitud_certificacion.* FROM solicitud_certificacion INNER JOIN opp ON solicitud_certificacion.idopp = opp.idopp ORDER BY solicitud_certificacion.fecha_registro ASC";  
...
$query = "SELECT * FROM solicitud_certificacion WHERE idopp = 0";
    ...
    <table class="table table-bordered table-striped" style="font-size:11px">
      <thead>
        <tr>
          ...
          <th class="text-center">Resolucion de Objeción</th>
  ...
  <!-------------------------------- INICIA SECCIÓN COTIZACIÓN ---------------------------------->
              <td class="text-center" style="width:150px;">
                <form action="" method="post">  
                  ...
                  ?>
                    <a class="btn btn-sm btn-success" href="<?echo $row_opp['cotizacion_opp']?>" target="_blank" type="button" data-toggle="tooltip" data-placement="top" title="Descargar Cotización">
                  ...
                  <?php 
                   ...
                   <?php 
                    ...
                    ?>
                      <!-- PROPUESTA ACEPTADA -->
                      <button class="btn btn-sm btn-info" type="submit" name="propuesta_txt" data-toggle="tooltip" data-placement="top" title="Aceptar Cotización" value="18"·>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
                      </button>
                      
                      <!-- PROPUESTA RECHAZADA -->
                      <button class="btn btn-sm btn-danger" type="submit" name="propuesta_txt" data-toggle="tooltip" data-placement="top" title="Rechazar Cotización" value="24">
                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 
                      </button>
                      <input type="hidden" name="fecha_registro" value="<?php echo $row_opp['fecha_registro']; ?>" >
                  ...
                  ?>
                      <button class="btn btn-sm btn-danger" type="submit" name="propuesta_txt" disabled>
                        ...
                        <input type="hidden" value="Haz rechazado la propuesta" name="mensaje" />
                      </button>
              ...
              <td>
                <div class="row">
                  <div class="col-xs-12">
                      ...
                      <?php }else{?>
                          <button class="btn btn-sm btn-default" disabled><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Estatus<br> Membresía SPP / Certificado</button>
                      <?php } ?>
                  </div>
                  <?php 
                  ...
                  ?>
                    <div class="col-xs-12">
                      <a style="font-size:11px;color:white;width:165px;" class="btn btn-success" href="<?php echo $registroCertificado['adjunto']; ?>" target="_blank">Descargar Certificado</a>
                    </div>
                  <?php
                    }
                   ?>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Membresía SPP/ Certificado</h4>
                            </div>
                                  ...
                                  <div class="col-xs-6 ">
                                      ...
                                      <?php if(empty($registroCertificado['idcertificado'])){ ?>
                                        <?php if($row_opp['status'] == 19){ ?>
                                          <div class="col-xs-12 alert alert-warning" role="alert">
                                            <div class="col-xs-12">
                                              Estatus Certificado: <strong>Se ha iniciado el proceso de certificación.</strong>  
                                            </div>                                  
                                          </div>
                                        <?php }else{ ?>
                                          <div class="col-xs-12 alert alert-danger" role="alert">
                                            <div class="col-xs-12">
                                              Estatus Certificado: <strong>No se ha iniciado el proceso de certificación.</strong>  
                                            </div>                                  
                                          </div>
                                        <?php } ?>
                                      <?php }else{ ?>
                                        <div class="col-xs-12 alert alert-success" role="alert">
                                          <div class="col-xs-12">
                                            Estatus Certificado al día: <b><?echo date("d/m/Y", $registroCertificado['fecha']) ?></b>
                                          </div>
                                          <hr>
                                          <div class="col-xs-12 ">
                                          <?
                                      ...
                                      ?>
                                          ...
                                          <div class="col-xs-12 alert alert-warning">
                                            <div class="col-xs-12"><h4>Contrato de Uso</h4></div>
                                            <div class="col-xs-12">
                                              Se ha cargado el Contrato de Uso SPP, así como el Acuse de Recibido.
                                            </div>
                                            <div class="col-xs-12">Estatus: <b><?php echo $registroContatos['estatusContrato']; ?></b></div>
                                      ...
                                      ?>
                                        <form action="" method="post" id="contrato_spp" enctype="multipart/form-data">
                                          <div class="col-xs-12 alert alert-warning">
                                            <div class="col-xs-12"><h4>Contrato de Uso</h4></div>
                                            <div class="col-xs-12">
                                              Por favor cargue el contrato de uso del SPP, asi como el acuse de recibido los cuales deberan estar debidamente firmados.
                                            </div>
                                            <div class="col-xs-12">
                                      ...
                                      ?>
                                          <div class="col-xs-12 alert alert-danger">
                                            <div class="col-xs-12"><h4>Contrato de Uso</h4></div>
                                            <div class="col-xs-12">
                                              Aun no ha finalizado el Proceso de Certificación.
                                            </div>
                                          </div>
                                      <?php 
                                      }
                    ...
                    <form action="" method="post" id="pagoCertificado" enctype="multipart/form-data">
                                  <?php if($registroCertificado['statuspago'] == "APROBADO"){ ?>
                                    <div class="col-xs-6 alert alert-success">
                                      <div class="col-xs-12">
                                      <p>Estatus Membresia: <b><?if(empty($registroCertificado['statuspago'])){echo "No se ha realizado el pago";}else{echo $registroCertificado['statuspago'];}?></b></p>
                                      <p><strong>Felicidades!!!</strong> su membresia ha sido acreditada, desde este momento podra disponer de su certificado.</p>
                                      </div>
                                      <div class="col-xs-12">
                                        <?php 
                                          if($registroCertificado['statuspago'] == "APROBADO"){
                                            echo "<div class='col-xs-6'><b><u>Su certificado vence el dia:  ".$registroCertificado['vigenciafin']."</u></b></div>";
                                          }
                                         ?>
