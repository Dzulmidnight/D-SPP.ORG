  ...
  <hr>
    <div class="row">
      <div class="col-md-5" >
        ...
        | <span class="alert alert-warning" style="padding:7px;">Total des organisations: <?php echo $totalOPP; ?></span>
      </div>
      <form action="" method="POST">
        <div class="col-md-7">
          <div class="input-group">
            <span class="input-group-btn">
              <button class="btn btn-default" type="submit" name="buscar" value="1">Rechercher</button>
            </span>
            <input type="text" class="form-control" name="campo_buscar" placeholder="Rechercher: #spp, mot, abréviation">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </form>
    </div>
    ...
    <table class="table table-bordered table-condensed table-hover" style="font-size:11px;">
      <thead>
        <tr>
          ...
          <th class="text-center"><a href="#" data-toggle="tooltip" title="Processus de certification dans lequel se trouve l'organisation"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>Processus de certification</a></th>
          ...
          <th class="text-center"><a href="#" data-toggle="tooltip" title="Statut du certificat défini à la date d'entrée en vigueur">
          ...
          <th>Produits</th>
          <th class="text-center">Nombre de<br> partenaires</th>
        ...
        <tbody>
          ...
          if($totalOPP == 0){
            ...
            ?>
              <tr>
                <td>
                  ...
                  <a class="btn btn-xs btn-primary" style="width:100%;" href="?OPP&amp;detail&amp;idopp=<?php echo $opp['idopp']; ?>">Voir les informations</a>
                </td>
                <td>
                  <?php echo $opp['nombre']; ?>
                </td>
            ...
            <!--- TERMINA ESTATUS_CERTIFICADO ---->
                ...
                <td>
                  <!-- ELIMINAR OPP -->
                  <button class="btn btn-sm btn-danger" data-toggle="tooltip" title="Supprimer l'organisation" type="submit" onclick="return confirm('Êtes-vous sûr ?, Les données seront supprimées en permanence');" name="eliminar_opp" value="<?php echo $opp['idopp']; ?>"><span aria-hidden="true" class="glyphicon glyphicon-trash"></span></button>
